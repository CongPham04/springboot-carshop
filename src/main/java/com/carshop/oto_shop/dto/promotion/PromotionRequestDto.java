...
public class PromotionRequestDto {
    ...
    public PromotionRequestDto(String title, String description, DiscountType discountType, BigDecimal discountValue, LocalDateTime startAt, LocalDateTime endAt, boolean active, PromotionScope appliesTo, List<String> targetCategories, List<String> targetBrands, List<Long> targetCarIds) {
        this.title = title;
